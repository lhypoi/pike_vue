	...
	<div id="main">
		...
		<div class="slide_div">
			...
			<div class="goods_detail" v-bind:class="generalClsObj">
				...
				<div class="ku">库存：<span>20</span></div>
		...
		<mt-button type="primary" @click="choice()">加入购物车</mt-button>
		...
		<mt-popup v-model="popupVisible" position="bottom" class="kuang" style="z-index: 2025;">
				...
				<strong class="price">总价：￥97674</strong>
...
.detail_box{
	...
	.goods_detail{
		...
		.ku,.sold{float: left;margin: 0 10px;}
		.gtype{float: right;margin: 0 20px;}
	}
	.box_fix{position: fixed;top: 0;left: 0;}
}
.choose{
...
.intro{
	background-color: #fff;
	h3{color: #000;background-color: #d4d2d2;text-align: left;font-size: 1.2rem;padding: 10px;line-height: 12px;}
	img{margin: 5px 10px;}
	.intro_detail{
		margin: 5px;
		color: #131212;
